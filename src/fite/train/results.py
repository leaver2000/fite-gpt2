...
# project imports
from .._argparse import ArgumentParser, DefaultNamespace, argument, Argument
...
def main(ns: Namespace) -> None:
    ...
    if ns.all:
        ...
        strategies = [strategy for strategy in HyperParameterStrategy if getattr(ns, strategy.name.lower(), False)]
